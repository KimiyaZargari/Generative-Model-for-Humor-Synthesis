"""
Trainer for general jokes dataset using instruction-following format
"""
...
DATA_PATH = "data/training-data/general_jokes.json"
OUTPUT_DIR = "models/general-body-only-jokes"
...
def main():
    ...
    # 1. Load tokenizer
    print("=" * 60)
    print("GENERAL JOKES TRAINER - Instruction Format")
    print("=" * 60)
